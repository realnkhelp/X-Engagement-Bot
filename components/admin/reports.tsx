          ...
          <div className="bg-card w-full max-w-md rounded-2xl shadow-2xl border border-border overflow-hidden flex flex-col max-h-[90vh] animate-in zoom-in-95 duration-200">
            ...
            <div className="p-5 overflow-y-auto space-y-6">
              ...
              <div className="bg-blue-50/50 dark:bg-blue-900/10 p-3 rounded-xl border border-blue-100 dark:border-blue-800">
                ...
                <div className="mt-2 text-sm bg-white dark:bg-zinc-900 p-2 rounded border border-blue-100 dark:border-blue-800 text-foreground">
                ...
                <div className="flex flex-col items-center">
                  ...
                  {selectedReport.reportedUser.taskLink && (
                    <a 
                      ...
                      className="mt-2 inline-flex items-center gap-1 text-xs bg-muted px-3 py-1 rounded-full hover:bg-muted/80 transition text-foreground"
                    >
                ...
                <div className="animate-in fade-in slide-in-from-top-2">
                  ...
                  <div className="flex gap-2">
                    <input 
                      ...
                      className="flex-1 p-2 text-sm border border-red-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500 bg-background text-foreground"
                      autoFocus
                    />
              ...
              <div className="flex items-center justify-center gap-3 pt-2">
                ...
                <button 
                  ...
                  className={`flex-1 flex items-center justify-center gap-2 border border-red-200 text-red-600 py-2.5 rounded-xl font-semibold hover:bg-red-50 transition active:scale-95 ${showRejectInput ? 'bg-red-50 dark:bg-red-900/20' : 'bg-transparent'}`}
                >
